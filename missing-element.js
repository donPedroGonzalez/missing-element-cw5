...
{   
    ...
    firstPart = [ "Podaj nazwę dokumentu", "permis de", "une", "une fiche d'", "un", "un", "une carte d'" ];
    secondPart = [ "Uzupełnij brakującą część", ".", "d'identité", ".", ".", "de séjour.", "." ];
    missingElement = [ "Expressions de base", "conduire", "carte", "inscription", "passeport", "titre", "étudiant" ];
    hints = [ "nan", "prawo jazdy", "dowód tożsamości", "karta zapisu", "paszport", "karta pobytu", "legitymacja studencka" ];
